...
class User(SQLModel, table=True):
    ...
    gender: bool = Field(nullable=True, default=False, description='Пол, 1 - муж, 0 - жен')
    ...
    is_registered: Optional[bool] = Field(default=True, description='Зарегистрирован ли')
