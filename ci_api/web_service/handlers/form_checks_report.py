...
def save_to_excel_file(checks: list[PaymentCheck], rates: list[Rate], user: User) -> str:
    ...
    worksheet.write('A1', "Телефон", cell_format)
    worksheet.write('B1', "Сумма", cell_format)
    worksheet.write('C1', "Тариф", cell_format)
    worksheet.write('D1', "Дата", cell_format)
    worksheet.write('E1', "Номер ордера", cell_format)
